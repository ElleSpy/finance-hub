#!/bin/bash
# Finance Hub — copy latest from Drive and push to GitHub

DRIVE_FILE="/Users/LauraSpires/Library/CloudStorage/GoogleDrive-lauraspires5@gmail.com/My Drive/AI Files/Cowork OS/Finance Hub/index.html"
LOCAL_REPO="$HOME/Documents/GitHub/finance-hub"
...
git commit -m "Finance Hub update - $(date '+%Y-%m-%d %H:%M')"
