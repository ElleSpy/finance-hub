...
_Last updated: May 1, 2026 (session 1)_
...
- **Deploying updates**: Upload updated `index.html` directly via https://github.com/ellespy/finance-hub (drag and drop → Commit changes). No git CLI needed.
